        ...
        for a = 1:length(movements)
            ...
            for m = 1:numMuscles
                ...
                posDeg=(pos.Data(StartFrontFlex(c):EndFrontFlex(c)))/5461;
                    ...
                    plot(posDeg, signal_norm_reduce(1:(EndFrontFlex(c)-StartFrontFlex(c)+1),m), 'Color', "#A2142F");
                ...
                posDeg=(pos.Data(StartLatFlex(c):EndLatFlex(c)))/5461;
                    ...
                    % Plot RMS envelope normlized to MVC
                    plot(posDeg, signal_norm_reduce(1:(EndLatFlex(c)-StartLatFlex(c)+1),m), 'Color', "#A2142F");
