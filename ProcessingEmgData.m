...
%data directory
datadir = fullfile('C:\Users\Mattia\OneDrive - Fondazione Istituto Italiano Tecnologia\Desktop\poli\tesi\Aquisition\Lore_emg', 'c3d');
...
for c = 1:length(conditions)
    ...
    for a = 1:length(movements)
        ...
        fname = sprintf('%s%s.c3d', condition, movement);
        ...
        for c = 1:length(conditions)
            ...
            if strcmp(movement,'LatFlex')
                if strcmp(condition,'ImpLowAss')
                    start=20000-6000+10000;

                elseif strcmp(condition,'ImpMediumAss')
                    start= 19132-6000+10000;
            ...
            elseif strcmp(movement,'FrontFlex')
                ...
                elseif strcmp(condition,'ImpHighAss')
                    start=29200-6000;
                elseif strcmp(condition,'ResConst')
                    start=22000-6000-5000;
                elseif strcmp(condition,'ResInteraction')
                    start=11001-6000-5000;
                end
            end
