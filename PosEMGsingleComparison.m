...
for a = 1:length(movements)
    ...
    %  figure('Name', sprintf('%s',movement), 'NumberTitle', 'off');
    ...
    for c = 1:3
        ...
        if a==1
            ...
            hold on
            title(sprintf('%s Impedance Comparison of %s of J%d', movement,nameMuscles{m},joint), 'FontSize', 18);
            xlabel('Position [°]', 'FontSize', 18);
            ylabel('Amplitude', 'FontSize', 18);
            set(gca, 'FontSize', 18);  % Set font size for tick labels
